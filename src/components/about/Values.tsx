const VALUES = [
  {
    ...
    description:
      "We constantly push boundaries to create better learning experiences using cutting-edge technology.",
    icon: (
      <path
        strokeLinecap="round"
  ...
  },
  {
    ...
    description:
      "Every decision we make is centered around helping our students achieve their goals and dreams.",
    icon: (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
